...
/*
 * Pi::service('api')->gallery(array('Text', 'keywords'), $keywords);
 * Pi::service('api')->gallery(array('Text', 'description'), $description);
 * Pi::service('api')->gallery(array('Text', 'alias'), $alias, $id, $model);
 */
